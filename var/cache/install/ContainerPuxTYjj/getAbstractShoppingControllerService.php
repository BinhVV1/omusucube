...
class getAbstractShoppingControllerService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.JyzFLkn'] ?? $container->load('get_ServiceLocator_JyzFLknService'))->withContext('Eccube\\Controller\\AbstractShoppingController', $container));
